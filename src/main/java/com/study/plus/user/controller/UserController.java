...
public class UserController {
    ...
    public ResponseEntity<SuccessResponse> signupRequest(@Valid @RequestBody MailRequestDto mailRequestDto,
    ...
    public ResponseEntity<SuccessResponse> checkNickname(@RequestBody NicknameRequestDto nicknameRequestDto) {
